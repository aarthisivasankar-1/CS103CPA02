...
//  Loading models
// *********************************************************** //
const ToDoItem = require("./models/BucketList")
...
app.post("/todosearch",async (req,res,next)=>{
  let obj = JSON.parse(JSON.stringify(req.body));
  let item_title = obj.title
  let titles = await ToDoItem.find({Title: {$regex: title}});
  res.locals.titles = titles;
  res.render("search_item", {title:title})
